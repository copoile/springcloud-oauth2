...
springcloud-oauth2搭建基于spring-cloud-starter-oauth2认证中心和资源服务器，项目不仅仅简单的demo，项目的出发点在于实战应用，我在某公司用的就是这个，
这个是我花了精力和时间整理出来的，只需要稍微调整就可应用于实际项目当中，并且项目包含大量注释，不仅可以让你会用，也可让你了解到一些流程、一些原理上的东西。
